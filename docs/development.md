...
1. Run program.
   Examples:
    ...
    1. Linux
        ...
        ```console
        ${GIT_REPOSITORY_DIR}/target/linux-amd64/go-messaging
    ...
    1. macOS
        ...
        ```console
        ${GIT_REPOSITORY_DIR}/target/darwin-amd64/go-messaging
    ...
    1. Windows
        ...
        ```console
        ${GIT_REPOSITORY_DIR}/target/windows-amd64/go-messaging
...
1. Senzing documentation will be in the "Third party" section.
   `github.com` > `senzing-garage` > `go-messaging`
...
[Go Reference]: https://pkg.go.dev/github.com/senzing-garage/go-messaging
[go]: https://github.com/senzing-garage/knowledge-base/blob/main/WHATIS/go.md
[localhost:6060]: http://localhost:6060/pkg/github.com/senzing-garage/go-messaging/
