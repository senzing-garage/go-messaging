...
More information at https://github.com/senzing/go-messaging
...
More information can be found in the [pkg/github.com/senzing/go-messaging/examplepackage] documentation.
...
Examples of use can be seen in the main_test.go files.
	...
	import (
		...
		"github.com/senzing/go-messaging/examplepackage"
		"github.com/senzing/go-messaging/anotherpackage"
	)
