...
var testCasesForTypedef = []struct {
...
}{
	{
		...
		expectedMessageJson: `{"time":"2000-01-01T00:00:00Z","level":"TRACE","id":"senzing-99990001","text":"TRACE: Bob works with Jane","status":"Status for 0001","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
	...
	},
	{
		...
		messageNumber:       1001,
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJson: `{"time":"2000-01-01T00:00:00Z","level":"DEBUG","id":"senzing-99991001","text":"DEBUG: Bob works with Jane","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
	...
	},
	{
		...
		messageNumber:       2001,
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJson: `{"time":"2000-01-01T00:00:00Z","level":"INFO","id":"senzing-99992001","text":"INFO: Bob works with Jane","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
	...
	},
	{
		...
		messageNumber:       2002,
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJson: `{"time":"2000-01-01T00:00:00Z","level":"INFO","id":"senzing-99992002","text":"Bob","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
		expectedText:        "Bob",
	},
	{
		name:                "typedef-2003",
		...
		expectedMessageJson: `{"time":"2000-01-01T00:00:00Z","level":"INFO","id":"senzing-99992002","text":"{\"a\":{\"b\":{\"c\":{\"d\":{\"e\":\"f\"},\"g\":{\"h\":\"i\"},\"j\":{}}},\"k\":{\"m\":{\"n\":\"o\"}},\"p\":{\"q\":\"r\"},\"s\":{\"t\":{\"u\":\"v\"}}},\"w\":\"x\"}","details":[{"position":1,"type":"string","value":"{\"a\":{\"b\":{\"c\":{\"d\":{\"e\":\"f\"},\"g\":{\"h\":\"i\"},\"j\":{}}},\"k\":{\"m\":{\"n\":\"o\"}},\"p\":{\"q\":\"r\"},\"s\":{\"t\":{\"u\":\"v\"}}},\"w\":\"x\"}","valueRaw":{"a":{"b":{"c":{"d":{"e":"f"},"g":{"h":"i"},"j":{}}},"k":{"m":{"n":"o"}},"p":{"q":"r"},"s":{"t":{"u":"v"}}},"w":"x"}},{"key":"text","position":2,"type":"map[string]string","value":"{\"a\":{\"b\":{\"c\":{\"d\":{\"e\":\"f\"},\"g\":{\"h\":\"i\"},\"j\":{}}},\"k\":{\"m\":{\"n\":\"o\"}},\"p\":{\"q\":\"r\"},\"s\":{\"t\":{\"u\":\"v\"}}},\"w\":\"x\"}","valueRaw":{"a":{"b":{"c":{"d":{"e":"f"},"g":{"h":"i"},"j":{}}},"k":{"m":{"n":"o"}},"p":{"q":"r"},"s":{"t":{"u":"v"}}},"w":"x"}}]}`,
	...
	},
	{
		...
		messageNumber:       2003,
		details:             []interface{}{jsonStrings[1], getTimestamp()},
		expectedMessageJson: `{"time":"2000-01-01T00:00:00Z","level":"INFO","id":"senzing-99992003","text":"JSON: {\"a\":{\"b\":{\"c\":{\"d\":{\"e\":\"f\"},\"g\":{\"h\":\"i\"},\"j\":{}}},\"k\":{\"m\":{\"n\":\"o\"}},\"p\":{\"q\":\"r\"},\"s\":{\"t\":{\"u\":\"v\"}}},\"w\":\"x\"}","details":[{"position":1,"type":"string","value":"{\"a\":{\"b\":{\"c\":{\"d\":{\"e\":\"f\"},\"g\":{\"h\":\"i\"},\"j\":{}}},\"k\":{\"m\":{\"n\":\"o\"}},\"p\":{\"q\":\"r\"},\"s\":{\"t\":{\"u\":\"v\"}}},\"w\":\"x\"}","valueRaw":{"a":{"b":{"c":{"d":{"e":"f"},"g":{"h":"i"},"j":{}}},"k":{"m":{"n":"o"}},"p":{"q":"r"},"s":{"t":{"u":"v"}}},"w":"x"}}]}`,
	...
	},
	{
		...
		messageNumber:       3001,
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJson: `{"time":"2000-01-01T00:00:00Z","level":"WARN","id":"senzing-99993001","text":"WARN: Bob works with Jane","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
	...
	},
	{
		...
		messageNumber:       4001,
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJson: `{"time":"2000-01-01T00:00:00Z","level":"ERROR","id":"senzing-99994001","text":"ERROR: Bob works with Jane","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
	...
	},
	{
		...
		messageNumber:       5001,
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJson: `{"time":"2000-01-01T00:00:00Z","level":"FATAL","id":"senzing-99995001","text":"FATAL: Bob works with Jane","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
	...
	},
	{
		...
		messageNumber:       6001,
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJson: `{"time":"2000-01-01T00:00:00Z","level":"PANIC","id":"senzing-99996001","text":"PANIC: Bob works with Jane","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
