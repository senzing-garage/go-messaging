...
var testCasesForMessage = []struct {
...
}{
	{
		...
		expectedMessageJSON: `{"time":"2000-01-01T00:00:00Z","level":"TRACE","id":"SZSDK99990001","text":"TRACE: Bob works with Jane","location":"In func1() at messenger_test.go:263","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
		expectedMessageSlog: []interface{}{"id", "SZSDK99990001", "location", "In func1() at messenger_test.go:276", "details", []Detail{{Key: "", Position: 1, Type: "string", Value: "Bob", ValueRaw: interface{}(nil)}, {Key: "", Position: 2, Type: "string", Value: "Jane", ValueRaw: interface{}(nil)}}},
	...
	},
	{
		...
		options:             []interface{}{getOptionIDMessages(), getOptionCallerSkip()},
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJSON: `{"time":"2000-01-01T00:00:00Z","level":"DEBUG","id":"SZSDK99991001","text":"DEBUG: Bob works with Jane","location":"In func1() at messenger_test.go:263","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
		expectedMessageSlog: []interface{}{"id", "SZSDK99991001", "location", "In func1() at messenger_test.go:276", "details", []Detail{{Key: "", Position: 1, Type: "string", Value: "Bob", ValueRaw: interface{}(nil)}, {Key: "", Position: 2, Type: "string", Value: "Jane", ValueRaw: interface{}(nil)}}},
	...
	},
	{
		...
		options:             []interface{}{getOptionIDMessages(), getOptionCallerSkip()},
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJSON: `{"time":"2000-01-01T00:00:00Z","level":"INFO","id":"SZSDK99992001","text":"INFO: Bob works with Jane","location":"In func1() at messenger_test.go:263","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
		expectedMessageSlog: []interface{}{"id", "SZSDK99992001", "location", "In func1() at messenger_test.go:276", "details", []Detail{{Key: "", Position: 1, Type: "string", Value: "Bob", ValueRaw: interface{}(nil)}, {Key: "", Position: 2, Type: "string", Value: "Jane", ValueRaw: interface{}(nil)}}},
	...
	},
	{
		...
		options:             []interface{}{getOptionIDMessages(), getOptionCallerSkip()},
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJSON: `{"time":"2000-01-01T00:00:00Z","level":"WARN","id":"SZSDK99993001","text":"WARN: Bob works with Jane","location":"In func1() at messenger_test.go:263","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
		expectedMessageSlog: []interface{}{"id", "SZSDK99993001", "location", "In func1() at messenger_test.go:276", "details", []Detail{{Key: "", Position: 1, Type: "string", Value: "Bob", ValueRaw: interface{}(nil)}, {Key: "", Position: 2, Type: "string", Value: "Jane", ValueRaw: interface{}(nil)}}},
	...
	},
	{
		...
		options:             []interface{}{getOptionIDMessages(), getOptionCallerSkip()},
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJSON: `{"time":"2000-01-01T00:00:00Z","level":"ERROR","id":"SZSDK99994001","text":"ERROR: Bob works with Jane","location":"In func1() at messenger_test.go:263","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
		expectedMessageSlog: []interface{}{"id", "SZSDK99994001", "location", "In func1() at messenger_test.go:276", "details", []Detail{{Key: "", Position: 1, Type: "string", Value: "Bob", ValueRaw: interface{}(nil)}, {Key: "", Position: 2, Type: "string", Value: "Jane", ValueRaw: interface{}(nil)}}},
	...
	},
	{
		...
		options:             []interface{}{getOptionIDMessages(), getOptionCallerSkip()},
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJSON: `{"time":"2000-01-01T00:00:00Z","level":"FATAL","id":"SZSDK99995001","text":"FATAL: Bob works with Jane","location":"In func1() at messenger_test.go:263","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
		expectedMessageSlog: []interface{}{"id", "SZSDK99995001", "location", "In func1() at messenger_test.go:276", "details", []Detail{{Key: "", Position: 1, Type: "string", Value: "Bob", ValueRaw: interface{}(nil)}, {Key: "", Position: 2, Type: "string", Value: "Jane", ValueRaw: interface{}(nil)}}},
	...
	},
	{
		...
		options:             []interface{}{getOptionIDMessages(), getOptionCallerSkip()},
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJSON: `{"time":"2000-01-01T00:00:00Z","level":"PANIC","id":"SZSDK99996001","text":"PANIC: Bob works with Jane","location":"In func1() at messenger_test.go:263","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
		expectedMessageSlog: []interface{}{"id", "SZSDK99996001", "location", "In func1() at messenger_test.go:276", "details", []Detail{{Key: "", Position: 1, Type: "string", Value: "Bob", ValueRaw: interface{}(nil)}, {Key: "", Position: 2, Type: "string", Value: "Jane", ValueRaw: interface{}(nil)}}},
	...
	},
	{
		...
		details:             []interface{}{"Bob", "Jane", getTimestamp()},
		expectedMessageJSON: `{"time":"2000-01-01T00:00:00Z","level":"PANIC","id":"Template: 7001","text":"PANIC: Bob works with Jane","status":"status-7001","location":"In func1() at messenger_test.go:263","details":[{"position":1,"type":"string","value":"Bob"},{"position":2,"type":"string","value":"Jane"}]}`,
		expectedMessageSlog: []interface{}{"id", "Template: 7001", "status", "status-7001", "location", "In func1() at messenger_test.go:276", "details", []Detail{{Key: "", Position: 1, Type: "string", Value: "Bob", ValueRaw: interface{}(nil)}, {Key: "", Position: 2, Type: "string", Value: "Jane", ValueRaw: interface{}(nil)}}},
		expectedText:        "PANIC: Bob works with Jane",
		expectedSlogLevel:   LevelPanicSlog,
	},
}
